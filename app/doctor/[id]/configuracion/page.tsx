...
import { verifyAndChangePassword } from '@/app/lib/data';
...
export default function DoctorConfigPage() {
  ...
  const id_medico = params.id;
  const handleChangePassword = async () => {
    try {
      setLoading(true);
      setError('');
      
      const result = await verifyAndChangePassword(Number(id_medico), currentPassword, newPassword);
